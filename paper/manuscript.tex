...
\item a strict-EXACT closure of the primordial scalar amplitude
      $A_{s}$: the magnitude is structural rather than EXACT
      against Planck~2018~\cite{Planck2018} (open
      additional-suppression refinement);
